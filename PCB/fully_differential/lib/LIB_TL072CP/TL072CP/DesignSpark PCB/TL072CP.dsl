...
(library Library_1
	...
	(symbolDef "TL072CP" (originalName "TL072CP")
	...
	(compDef "TL072CP" (originalName "TL072CP") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "2OUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "2IN-") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "2IN+") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TL072CP"))
		...
		(attr "Mouser Part Number" "595-TL072CP")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TL072CP?qs=5nGYs9Do7G3e6Tx9uHIgUA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TL072CP")
		(attr "Description" "Dual Low-Noise JFET-Input General-Purpose Operational Amplifier")
		(attr "Datasheet Link" "http://www.ti.com/lit/ds/symlink/tl071a.pdf")
		(attr "Height" "5.08 mm")
	)
