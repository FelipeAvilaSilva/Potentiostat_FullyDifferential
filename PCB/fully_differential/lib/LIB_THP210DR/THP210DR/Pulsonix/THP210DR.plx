...
//13755748/1189128/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "THP210DR" (originalName "THP210DR")
	...
	(compDef "THP210DR" (originalName "THP210DR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "IN-") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "VOCM") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "__PD") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "THP210DR"))
		...
		(attr "Mouser Part Number" "595-THP210DR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/THP210DR?qs=eP2BKZSCXI6TpSz98mjAmQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "THP210DR")
		(attr "Description" "Operational Amplifiers - Op Amps High precision (40- V, 0.1 V/C), high-voltage (36-V), low-noise (3.7-nV/ Hz), fully-differential amp 8-SOIC -40 to 125")
		(attr "<Hyperlink>" "https://www.ti.com/lit/gpn/THP210")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "THP210DR.stp")
