...
//179440/1189128/2.50/3/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "L7809CV" (originalName "L7809CV")
	...
	(compDef "L7809CV" (originalName "L7809CV") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "L7809CV"))
		...
		(attr "Mouser Part Number" "511-L7809CV")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/L7809CV?qs=sps7W%2FwBcGH358Eg%2FiFhSA%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "L7809CV")
		(attr "Description" "Standard Regulator 9V 1.5A STMicroelectronics L7809CV, Single Linear Voltage Regulator, 1.5A 9 V, 2%, 3-Pin TO-220")
		(attr "<Hyperlink>" "http://www.st.com/web/en/resource/technical/document/datasheet/CD00000444.pdf")
		(attr "<Component Height>" "4.6")
		(attr "<STEP Filename>" "L7809CV.stp")
